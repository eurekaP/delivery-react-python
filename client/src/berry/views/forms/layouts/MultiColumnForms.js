...
// material-ui
import { Checkbox, Divider, Grid, InputAdornment, TextField, FormControlLabel, FormHelperText, RadioGroup, Radio, Typography } from '@material-ui/core';
                    ...
                    <Grid container spacing={2} alignItems="center">
                        ...
                        <Grid item xs={12} lg={6}>
                            ...
                            <TextField type="password" fullWidth placeholder="Enter Password"
                                InputProps={{
                                    endAdornment: (<InputAdornment position="end"><LockTwoToneIcon /></InputAdornment>)
                                }}
                            />
                        ...
                        <Grid item xs={12} lg={6}>
                            ...
                            <TextField fullWidth placeholder="Please enter your Profile URL"
                                InputProps={{
                                    endAdornment: (<InputAdornment position="end"><LinkTwoToneIcon /></InputAdornment>)
                                }}
                            />
                            <FormHelperText>Please enter your Profile URL</FormHelperText>
                        </Grid>
                        <Grid item xs={12} lg={6}>
                            <Typography variant="subtitle1" component="div" sx={{ mb: 1 }}>language:</Typography>
                ...
                <MainCard title='3 Columns Form Layout'>
                    <Grid container spacing={2} alignItems="center">
                        ...
                        <Grid item xs={12} lg={4}>
                            ...
                            <TextField type="password" fullWidth placeholder="Enter Password"
                                InputProps={{
                                    startAdornment: (<InputAdornment position="start"><LockTwoToneIcon /></InputAdornment>)
                                }}
                            />
                            <FormHelperText>Please enter Password</FormHelperText>
                        </Grid>
